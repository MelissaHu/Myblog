...
module.exports = function(app) {
    app.get('/', function(req, res) {
        ...
        Post.getTen(null, page, function(err, posts, total) {
            ...
            res.render('index', {
                ...
                posts: posts,
                page: page,
                pages: (total % 5 == 0) ? (total / 5) : parseInt(total / 5) + 1,
    ...
    app.post('/post', function(req, res) {
        var currentUser = req.session.user,
            ...
            post = new Post(currentUser.name, currentUser.head, req.body.title, tags, req.body.post, req.body.kinds, req.body.top_article);
    ...
    app.post('/edit/:_id', function(req, res) {
        Post.update(req.params._id, req.body.post, function(err) {
            ...
            console.log("url:", req.params._id);
    ...
    app.get('/kinds/:kinds', function(req, res) {
        Post.getKind(req.params.kinds, function(err, posts) {
            if (err) {
                req.flash('error', err);
                return res.redirect('/');
            }
